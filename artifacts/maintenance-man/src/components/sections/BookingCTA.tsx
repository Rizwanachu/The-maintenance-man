...
export default function BookingCTA() {
  return (
    <section className="py-16 md:py-28 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-white/10 via-primary to-primary"></div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto h-12 px-8 text-base font-bold bg-white text-primary hover:bg-white/90 rounded-md"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full sm:w-auto h-12 px-8 text-base font-bold border-2 border-white/30 text-white hover:bg-white/10 rounded-md"
            >
