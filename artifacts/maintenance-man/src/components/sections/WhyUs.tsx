...
const reasons = [
  {
    ...
    description: 'Extensive background treating elite athletes and everyday clients alike.',
  },
  {
    title: 'Tailored Treatment Plans',
    description: 'Every single session is personalised to your specific needs and goals.',
  },
  {
  ...
  return (
    <section className="py-16 md:py-32 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-x-8 md:gap-y-10">
